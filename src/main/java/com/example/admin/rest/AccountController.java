...
public class AccountController {
	...
	@CrossOrigin(origins = "http://localhost:3000")
	public ResponseEntity<Map<String,String>> editUserAccount(@PathVariable("id") Long userId,  @RequestBody  EditUserAccount ed) {
	...
	@CrossOrigin(origins = "http://localhost:3000")
	public ResponseEntity<Map<String, String>> deletyById(@PathVariable Long id) {
